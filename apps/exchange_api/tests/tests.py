...
class TestApiKeys(TestCase):
    ...
    def test_detail_apikey(self):
        ...
        request = self.client.get(
            reverse("apikey:ApiKeyDetail", kwargs={"pk": data.id})
        )
        self.assertEqual(request.status_code, 200)
    ...
    def test_detail_apikey_with_invalid_id(self):
        ...
        request = self.client.get(
            reverse("apikey:ApiKeyDetail", kwargs={"pk": 922337203685477580})
        )
        self.assertEqual(request.status_code, 200)
    ...
    def test_update_apikey_with_invalid_paramter(self):
        ...
        request = self.client.put(
            reverse("apikey:ApiKeyUpdate", kwargs={"pk": 922337203685477580}),
            data=update,
        )
        self.assertEqual(request.status_code, 200)
    ...
    def test_update_apikey(self):
        ...
        request = self.client.put(
            reverse("apikey:ApiKeyUpdate", kwargs={"pk": data.id}), data=update
        )
        self.assertEqual(request.status_code, 200)
    ...
    def test_delete_apikey(self):
        ...
        request = self.client.delete(
            reverse("apikey:ApiKeyDelete", kwargs={"pk": data.id})
        )
    ...
    def test_delete_apikey_with_invalid_id(self):
        ...
        request = self.client.delete(
            reverse("apikey:ApiKeyDelete", kwargs={"pk": 922337203685477580})
        )
        self.assertEqual(request.status_code, 200)
