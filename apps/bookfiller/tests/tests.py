...
class TestBookFiller(TestCase):
    ...
    def test_add_bookfiller_wth_wrong_parameter(self):
        ...
        self.assertEqual(request.json(), expect_response)
    ...
    def test_get_all_bookfiller(self):
        ...
        self.assertEqual(request.json()[0]['user_id'], data[0]['user_id'])
        self.assertEqual(request.json()[0]['api_key_id'], data[0]['api_key_id'])
        self.assertEqual(request.json()[0]['number_of_orders'], data[0]['number_of_orders'])
    ...
    def test_detail_bookfiller(self):
        ...
        self.assertEqual(request.json()[0]["user_id"], data.user_id)
    ...
    def test_delete_apikey_with_invalid_id(self):
        ...
        expect_response = {'status': 'data not found'}
        self.assertEqual(request.status_code, 404)
        self.assertDictEqual(request.json(), expect_response)
